...
import { EmptyStateCard, SeverityBorderIcon, TablePagination, UISeverity } from "@/shared/ui";
...
export function AlertTableServerSide({
  ...
  function renderTable() {
    ...
    return (
      <Table className="[&>table]:table-fixed [&>table]:w-full [&>table]:border-collapse [&>table]:border [&>table]:border-gray-200 [&>table>thead>tr>th]:border [&>table>thead>tr>th]:border-gray-200 [&>table>tbody>tr>td]:border [&>table>tbody>tr>td]:border-gray-200">
        <AlertsTableHeaders
          columns={columns}
          table={table}
          presetName={presetName}
    ...
    <div className="h-full flex flex-col gap-0 bg-[#fff] border border-[#e5e7eb]">
      ...
      <div className="pb-4">
        <div className="flex-col gap-4">
          ...
          />
          {/* Full search */}
          <div className="flex gap-10 px-2 justify-between items-center bg-white border-b border-gray-200 dark:bg-gray-900 dark:border-gray-700 z-10">
