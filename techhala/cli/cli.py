...
from techhala.api.core.posthog import posthog_client
from techhala.functions import cyaml
from techhala.providers.models.provider_config import ProviderScope
...
def get_default_conf_file_path():
    DEFAULT_CONF_FILE = ".techhala.yaml"
