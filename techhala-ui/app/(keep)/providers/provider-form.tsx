                  ...
                  <>
                    ...
                    >
                      ...
                      <Icon
                        ...
                        color="gray"
                        size="sm"
                        tooltip={`Whether TechHala should try to pull alerts automatically from the provider once in a while`}
                      />
                    </label>
                  </>
                )}
              ...
              {isLocalhost && (
                <span className="text-sm">
                  ...
                  >
                    ...
                    >
                      Webhook installation is disabled because TechHala is running
      ...
      <div className="flex-grow p-5">
        ...
        <Subtitle>
          ...
          <Link
            ...
            href={`${
              config?.KEEP_DOCS_URL || "http://docs.techhala.com"
