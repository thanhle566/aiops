      ...
      >
        ...
        {shouldShowMenu && (
          <DropdownMenu.Menu
            ...
            label=""
            className="opacity-0 group-hover:opacity-100 transition-opacity border-l !border-[#2C4A4B] hover:!bg-[#2C4A4B] text-[#2C4A4B] hover:text-white dark:hover:text-gray-900 !rounded-none"
            iconClassName=" "
            onClick={(event) => {
