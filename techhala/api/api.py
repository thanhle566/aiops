...
import techhala.api.logging
import techhala.api.observability
import techhala.api.utils.import_ee
from techhala.api.arq_worker import get_arq_worker
from techhala.api.consts import (
...
from techhala.api.core.db import dispose_session
from techhala.api.core.dependencies import SINGLE_TENANT_UUID
from techhala.api.core.limiter import limiter
from techhala.api.logging import CONFIG as logging_config
from techhala.api.middlewares import LoggingMiddleware
from techhala.api.routes import (
    actions,
    ai,
    alerts,
    dashboard,
...
from techhala.api.routes.auth import groups as auth_groups
from techhala.api.routes.auth import permissions, roles, users
from techhala.event_subscriber.event_subscriber import EventSubscriber
from techhala.identitymanager.identitymanagerfactory import (
    IdentityManagerFactory,
    IdentityManagerTypes,
)
from techhala.topologies.topology_processor import TopologyProcessor

# load all providers into cache
from techhala.workflowmanager.workflowmanager import WorkflowManager

load_dotenv(find_dotenv())
techhala.api.logging.setup_logging()
...
def get_app(
    ...
    if config("KEEP_OTEL_ENABLED", default="true", cast=bool):
        techhala.api.observability.setup(app)
...
def run(app: FastAPI):
    ...
    import techhala.api.config

    techhala.api.config.on_starting()

    uvicorn.run(
        "techhala.api.api:get_app",
        host=HOST,
        port=PORT,
