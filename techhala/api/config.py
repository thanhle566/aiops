...
from techhala.api.api import AUTH_TYPE
from techhala.api.core.db_on_start import migrate_db, try_create_single_tenant
from techhala.api.core.dependencies import SINGLE_TENANT_UUID
from techhala.api.core.tenant_configuration import TenantConfiguration
from techhala.api.routes.dashboard import provision_dashboards
from techhala.identitymanager.identitymanagerfactory import IdentityManagerTypes
...
def post_worker_init(worker):
    ...
    techhala.api.logging.setup_logging()  # noqa
