...
from techhala.providers.base.base_provider import BaseTopologyProvider, ProviderHealthMixin
from techhala.providers.base.provider_exceptions import GetAlertException
from techhala.providers.datadog_provider.datadog_alert_format_description import (
...
from techhala.validation.fields import HttpsUrl
...
class DatadogProvider(BaseTopologyProvider, ProviderHealthMixin):
    ...
    def simulate_alert(cls) -> dict:
        ...
        from techhala.providers.datadog_provider.alerts_mock import ALERTS
