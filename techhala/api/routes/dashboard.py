...
from techhala.api.core.db import delete_dashboard as delete_dashboard_db
from techhala.api.core.db import get_dashboards as get_dashboards_db
from techhala.api.core.db import update_dashboard as update_dashboard_db
