      ...
      <Popover.Root open={isOpen} onOpenChange={setIsOpen}>
        <Popover.Trigger asChild>
          <Button
            ...
            variant="secondary"
            className={clsx(
              "justify-start bg-white border-b border-gray-200 hover:bg-gray-50 h-9",
      ...
      <div className="flex items-center relative z-0 gap-x-2 ml-2 h-full">
        <div className="flex h-9">
          {hasPlay && (
            <Button
              ...
              color="gray"
              variant="secondary"
              className="bg-white hover:bg-gray-50 justify-start rounded-none border-b border-gray-200 h-9"
          ...
          {hasForward && (
            <Button
              ...
              color="gray"
              variant="secondary"
              className="justify-start border-b border-gray-200"
        ...
        {hasZoomOut && (
          <Button
            ...
            color="gray"
            variant="secondary"
            className="justify-start rounded-none border-gray-200"
