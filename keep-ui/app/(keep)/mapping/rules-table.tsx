      ...
      <Table className="border border-gray-200 rounded-lg">
          ...
          {table.getHeaderGroups().map((headerGroup) => (
            ...
            >
              {headerGroup.headers.map((header) => (
                <TableHeaderCell
                  className={`text-tremor-content-strong dark:text-dark-tremor-content-strong border-r last:border-r-0 ${
        ...
        <TableBody>
          {table.getRowModel().rows.map((row) => (
            <TableRow
              className="hover:bg-slate-100 group cursor-pointer border-b last:border-b-0"
              key={row.id}
              onClick={() =>
