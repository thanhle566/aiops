...
from techhala.api.core.db import get_session, push_logs_to_db
from techhala.api.models.db.provider import ProviderExecutionLog
...
CONFIG = {
    ...
    "handlers": {
        ...
        "workflowhandler": {
            ...
            "class": "techhala.api.logging.WorkflowDBHandler",
    ...
    "filters": {  # Add filters section
        "thread_context": {"()": "techhala.api.logging.WorkflowContextFilter"}
    },
    "loggers": {
        "": {
