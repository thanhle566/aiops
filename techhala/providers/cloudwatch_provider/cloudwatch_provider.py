...
from techhala.providers.base.base_provider import BaseProvider, ProviderHealthMixin
...
class CloudwatchProviderAuthConfig:
    ...
    session_token: str = dataclasses.field(
        ...
        metadata={
            ...
            "hint": "For temporary credentials. Note that if you connect CloudWatch with temporary credentials, the initial connection will succeed, but when the credentials expired alarms won't be sent to techhala.",
            "sensitive": True,
        },
    )
...
class CloudwatchProvider(BaseProvider, ProviderHealthMixin):
    """Push alarms from AWS Cloudwatch to techhala."""
    ...
    def simulate_alert(cls) -> dict:
        ...
        from techhala.providers.cloudwatch_provider.alerts_mock import ALERTS
