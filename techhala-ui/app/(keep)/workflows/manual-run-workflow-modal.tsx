    ...
    try {
      ...
      toast.success(
        <div>
          ...
          <Link
            href={executionUrl}
            className="text-[#2C4A4B] hover:text-orange-600 underline"
            onClick={(e) => {
              e.stopPropagation();
            }}
          >
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-end gap-2 mt-4">
        <Button onClick={clearAndClose} className="btn-secondary" variant="secondary">
          Cancel
        </Button>
        <Button onClick={handleRun} className="btn-primary" disabled={!selectedWorkflow}>
          Run
        </Button>
      </div>
    </Modal>
