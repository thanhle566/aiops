...
const DroppableContainer: React.FC<{
  ...
  return (
    <div
      ref={setNodeRef}
      className={`transition-colors ${isOver ? "bg-primary-50" : ""}`}
    >
      {children}
    </div>
  );
    ...
    <Card key={incident.id} className="mb-6 relative">
      <div className="absolute top-4 right-4">
        <Button 
          className={isEditing 
            ...
            : "text-primary-500 hover:bg-primary-50 border-primary-500"
          }
      ...
      {isEditing ? (
        ...
        <>
          ...
          <Badge  color="red">{editedIncident.severity || "N/A"}</Badge>
