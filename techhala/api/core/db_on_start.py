...
from techhala.api.core.db_utils import create_db_engine
...
from techhala.api.models.db.statistics import *  # pylint: disable=unused-wildcard-import
...
def try_create_single_tenant(tenant_id: str, create_default_user=True) -> None:
    ...
    from techhala.api.models.db.user import User  # pylint: disable=import-outside-toplevel
    ...
    with Session(engine) as session:
        try:
            ...
            if os.environ.get("KEEP_DEFAULT_API_KEYS", ""):
                ...
                from techhala.secretmanager.secretmanagerfactory import SecretManagerFactory
