...
from techhala.api.models.facet import CreateFacetDto, FacetDto, FacetOptionDto, FacetOptionsQueryDto
...
from techhala.api.models.db.facet import Facet, FacetType
