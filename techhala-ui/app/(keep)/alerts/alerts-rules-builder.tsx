  ...
  return (
    <>
            ...
            <div className="flex-grow relative" ref={wrapperRef}>
              <div className="relative">
                ...
                <Textarea
                  ref={textAreaRef}
                  rows={1}
                  className="resize-none overflow-hidden w-full pr-9 pl-9 min-h-10 border border-gay-200" // Added pl-9 for left padding to accommodate icon
                  value={celRules}
      ...
      <Modal
        ...
        className="w-[50%] max-w-screen-2xl max-h-[710px] transform overflow-auto ring-tremor bg-white p-6 text-left align-middle shadow-tremor transition-all"
        title="Query Builder"
      >
