...
from techhala.api.arq_pool import get_pool
from techhala.api.bl.enrichments_bl import EnrichmentsBl
from techhala.api.consts import KEEP_ARQ_QUEUE_BASIC
from techhala.api.core.alerts import (
    get_alert_facets,
    get_alert_facets_data,
    get_alert_potential_facet_fields,
    query_last_alerts,
)
from techhala.api.core.cel_to_sql.sql_providers.base import CelToSqlException
from techhala.api.core.config import config
from techhala.api.core.db import dismiss_error_alerts as dismiss_error_alerts_db
from techhala.api.core.db import enrich_alerts_with_incidents
from techhala.api.core.db import get_alert_audit as get_alert_audit_db
from techhala.api.core.db import (
    get_alerts_by_fingerprint,
    get_alerts_metrics_by_provider,
    get_enrichment,
)
from techhala.api.core.db import get_error_alerts as get_error_alerts_db
from techhala.api.core.db import (
...
from techhala.api.core.dependencies import extract_generic_body, get_pusher_client
from techhala.api.core.elastic import ElasticClient
from techhala.api.core.metrics import running_tasks_by_process_gauge, running_tasks_gauge
from techhala.api.models.action_type import ActionType
from techhala.api.models.alert import (
    AlertDto,
    AlertErrorDto,
    AlertStatus,
    DeleteRequestBody,
...
from techhala.api.models.alert_audit import AlertAuditDto
from techhala.api.models.db.incident import IncidentStatus
from techhala.api.models.db.rule import ResolveOn
from techhala.api.models.facet import FacetOptionsQueryDto
from techhala.api.models.query import QueryDto
from techhala.api.models.search_alert import SearchAlertsRequest
from techhala.api.models.time_stamp import TimeStampFilter
from techhala.api.routes.preset import pull_data_from_providers
from techhala.api.tasks.process_event_task import process_event
from techhala.api.utils.email_utils import EmailTemplates, send_email
from techhala.api.utils.enrichment_helpers import convert_db_alerts_to_dto_alerts
from techhala.api.utils.time_stamp_helpers import get_time_stamp_filter
...
async def receive_generic_event(
    ...
    """
    A generic webhook endpoint that can be used by any provider to send alerts to techhala.

    Args:
        alert (AlertDto | list[AlertDto]): The alert(s) to be sent to techhala.
