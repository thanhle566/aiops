  ...
  return (
    <Transition appear show={isOpen} as={Fragment}>
      <Dialog onClose={toggle}>
        ...
        >
          <Dialog.Panel className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] max-h-[90vh] bg-white z-30 p-6 overflow-auto flex flex-col shadow-xl">
