...
const DeduplicationSidebar: React.FC<DeduplicationSidebarProps> = ({
  ...
  return (
    <Dialog open={isOpen} onClose={handleToggle} className="relative z-50">
                      ...
                      <span className="text-sm font-medium text-gray-700 flex items-center mb-2">
                        ...
                        <span className="ml-1 relative inline-flex items-center">
                          <span className="group relative flex items-center">
                            ...
                            />
                            <span className="absolute bottom-full left-full p-2 bg-gray-800 text-white text-xs opacity-0 group-hover:opacity-100 transition-opacity duration-300 w-80 text-center pointer-events-none group-hover:pointer-events-auto">
