...
export const getRowClassName = (
  ...
  return clsx(
    ...
    isLastViewed ? "bg-primary-50" : rowBgColor,
...
export const getCellClassName = (
  ...
  return clsx(
    ...
    "group-hover:bg-primary-100", // Group hover styling
    isLastViewed && "bg-primary-50" // Override with highlight if this is the last viewed row
  );
};
