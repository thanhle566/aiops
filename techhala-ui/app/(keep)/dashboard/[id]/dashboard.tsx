      ...
      <div className="flex items-center justify-between mb-4">
        <div className="relative">
          {isEditingName ? (
            <TextInput
              ...
              className="border-[#2C4A4B] focus:border-orange-600 focus:ring-orange-600"
            />
          ) : (
            <Subtitle  color="red" className="mr-2">
              {dashboardName}
            </Subtitle>
          )}
          <Icon
        ...
        <div className="flex gap-1 items-end">
          ...
          <div className="flex">
            ...
            />
            <Button className="ml-2 btn-primary" onClick={openModal}>
              Add Widget
            </Button>
          </div>
        </div>
