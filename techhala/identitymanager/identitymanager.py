...
from techhala.api.models.user import ResourcePermission, Role
...
from techhala.identitymanager.authverifierbase import ALL_RESOURCES, AuthVerifierBase
from techhala.identitymanager.rbac import get_role_by_role_name

rbac_module = importlib.import_module("techhala.identitymanager.rbac")
PREDEFINED_ROLES = []
