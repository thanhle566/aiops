...
export default async function RootLayout({ children }: RootLayoutProps) {
  ...
  return (
    <html lang="en" className={`${mulish.className}`}>
      <body className="h-screen flex flex-col lg:grid lg:grid-cols-[215px_30px_auto] xl:grid-cols-[250px_30px_auto] lg:grid-rows-[auto_1fr] lg:has-[aside[data-minimized='true']]:grid-cols-[0px_30px_auto]">
            ...
            <NextAuthProvider session={session}>
              <TopologyPollingContextProvider>
                <FrigadeProvider>
                  ...
                  <main className="page-container flex flex-col col-start-3 row-start-2 overflow-auto">
