      ...
      cell: ({ row }) => {
        ...
        return triggered_by ? (
          <div className="flex items-center gap-2">
            <Button
              className="px-3 py-1 bg-orange-100 text-black border-2 border-orange-400 inline-flex items-center gap-2 font-bold hover:bg-orange-200"
              variant="secondary"
        ...
        return triggered_by ? (
          <div className="flex items-center gap-2 flex-wrap">
            {details.map((detail, index) => (
              <Badge key={index} className="px-3 py-1"  color="red">
                {detail}
              </Badge>
            ))}
          </div>
