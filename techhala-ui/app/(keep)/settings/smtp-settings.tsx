    ...
    <div className="flex flex-col gap-4">
      ...
      <Card className="p-4">
        ...
        <div className="flex flex-col justify-end space-y-2 mt-6">
          <div className="flex justify-end space-x-2">
            <Button onClick={onSave} className="btn-primary px-4 py-2">
              Save
            </Button>
            <Button
              onClick={onDelete}
      ...
      <Card className="p-4">
        <div className="mb-4">
          ...
          />
          <label className="block text-sm font-medium mb-1 text-gray-500">
            A test mail address. TechHala will try to send email to this address.
          </label>
          {errors.to_email && (
        ...
        <div className="flex justify-end space-x-2 mt-6">
          <Button onClick={onTest} className="btn-primary px-4 py-2">
            Test
          </Button>
        </div>
      </Card>
